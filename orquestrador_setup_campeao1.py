...
API_KEY = "nQxV0piIiysutaluNq6GOabS3kUGvBeIBPA3DD5V8NmVWuWeV6uWpMyiJGMASVjR"
API_SECRET = "TuAj0T0R814yHbl3iehg2HHYDifT5yo73guZ82FcAPTScKxiD5joM45fSmd3Onnp"
...
CONFIG_BY_SYMBOL = {
    "AVAXUSDT": {
        "brick_size": 0.0010,          # Tamanho em % do preco (LTP %) (ex: 0.005 = 0.5%)
        "stop_loss_bricks": 10,         # Numero de bricks para stop loss
    },
    "ADAUSDT": {
        "brick_size": 0.001
        ,
...
BOT_FILENAME = "bot_setup_campeao1.py"
...
def start_bot(symbol: str):
    ...
    os.makedirs("bot_logs1", exist_ok=True)
    log_file = f"bot_logs1/log_{symbol}_{datetime.now().strftime('%Y%m%d_%H%M%S')}.txt"
