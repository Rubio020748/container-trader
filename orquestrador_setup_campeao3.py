...
API_KEY = "K8MxVI93ViNMVv11aTaCVHCf2rdMPUHcgkeMeOz4GbidQrGdk9H46eY93xvf5bUY"
API_SECRET = "JD8XfX8pFgxbLTRwTSVGwN1iJuAB6iNu8oO74UTN2Qgmi9yd7X70fQfaWMBS6Kdf"
...
CONFIG_BY_SYMBOL = {
    "AVAXUSDT": {
        ...
        "stop_loss_bricks": 3,         # Numero de bricks para stop loss
    },
    "ADAUSDT": {
        "brick_size": 0.0030,          # Tamanho em % do preco (LTP %) (ex: 0.005 = 0.5%)
        "stop_loss_bricks": 3,
...
BOT_FILENAME = "bot_setup_campeao3.py"
...
def start_bot(symbol: str):
    ...
    os.makedirs("bot_logs3", exist_ok=True)
    log_file = f"bot_logs3/log_{symbol}_{datetime.now().strftime('%Y%m%d_%H%M%S')}.txt"
